...
public class HomeController extends Controller {
	...
	public Result getAssignment(String role, Long assignmentId){
		...
		List<Problem> problems = Problem.find.fetch("assignment").where().eq("assignment.assignmentId",assignmentId).orderBy("problem.problemId").findList();
	...
	public Result saveEditedAssignment(Long assignment) {
	    ...
	    List<Problem> problems = Problem.find.fetch("assignment").where().eq("assignment.assignmentId",assignment1.assignmentId).orderBy("problem.problemId").findList();
